...
void MainWindow::read_regs()
{
    ...
    if( count_read > MODBUS_MAX_READ_REGISTERS)
    {
    ...
    mb.read_regs(address_read, count_read, rd_buf);
}
...
void MainWindow::write_reg()
{
    ...
    mb.write_reg(address_write, value_write);
}
...
void MainWindow::sw01_on(bool checked)
{
    mb.set_slave(1);
    mb.connect();
    if(checked == true)
...
void MainWindow::sw02_on(bool checked)
{
    mb.set_slave(1);
    mb.connect();
    if(checked == true)
...
void MainWindow::sw03_on(bool checked)
{
